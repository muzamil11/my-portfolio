  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Message Sent ✅",
        description:
          "Thanks for contacting me! Your inquiry is in my inbox, and I’ll reply shortly.",
      });
            ...
            <div className="lg:col-span-3">
              <div className="animate-slide-in-right">
                ...
                <div className="mt-6 p-4 bg-primary/5 rounded-lg border border-primary/20">
                  <p className="text-sm text-gray-600">
                    <strong>Note:</strong> I typically respond to all inquiries
                    within 24 hours. For urgent matters, feel free to reach out
                    directly via phone or LinkedIn.
                  </p>
                </div>
              </div>
            </div>
